...
router.get("/",auth(USER_ROLE.admin,USER_ROLE.user) ,servicesController.getAllServices)
router.get("/:id",auth(USER_ROLE.admin,USER_ROLE.user) ,servicesController.getSingleServices)
